...
const ROUTE_BASICS = {
  'AK-01': { color: '#5AC3FF', destinations: ['Term. Merdeka', 'Cipaku', 'Cipinang Gading'] },
  'AK-02': { color: '#C52022	', destinations: ['Sukasari', 'Term. Bubulak'] },
  'AK-03': { color: '#0077CC', destinations: ['Term. Bubulak', 'Term. Baranangsiang'] },
  'AK-04': { color: '#1E6AE7', destinations: ['Warung Nangka', 'Rancamaya', 'Ramayana'] },
  'AK-05': { color: '#FCAFF9', destinations: ['Cimahpar', 'Ramayana'] },
  'AK-06': { color: '#FDEE67', destinations: ['Cileuheut', 'Ramayana'] },
  'AK-07': { color: '#D7D8E2', destinations: ['Ciparigi', 'Term. Merdeka'] },
  'AK-07A': { color: '#D7D8E2', destinations: ['Ciparigi', 'Ramayana'] },
  ...
  'AK-11': { color: '#683F37', destinations: ['Pajajaran Indah', 'Pasar Bogor'] },
  'AK-12': { color: '#FDEE67', destinations: ['Cimanggu', 'Pasar Anyar'] },
  'AK-13': { color: '#B60A37', destinations: ['Ramayana', 'Bantar Kemang', 'Mutiara Bogor Raya'] },
  'AK-14': { color: '#FF00E4', destinations: ['Sukasari', 'Term. Bubulak'] },
  'AK-15': { color: '#FFD9CF', destinations: ['Term. Merdeka', 'Term. Bubulak', 'Sindang Barang Jero'] },
  'AK-16': { color: '#D7D8E2', destinations: ['Pasar Anyar', 'Salabenda'] },
