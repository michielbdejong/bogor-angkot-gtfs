...
const ROUTE_BASICS = {
  ...
  'AK-02': { color: '#C52022	', destinations: ['Sukasari', 'Terminal Bubulak'] },
  ...
  'AK-07': { color: '#D7D8E2', destinations: ['Ciparigi', 'Terminal Merdeka'], aka: '07C' },
  ...
  'AK-10': { color: '#B6B1B8', destinations: ['Bantar Kemang', 'Sukasari', 'Terminal Merdeka'] },
